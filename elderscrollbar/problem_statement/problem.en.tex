...
The viewport must show line $L$ of the adjusted input at the top line; lines are numbered $0,\ldots, T-1$, where $T$ is the total number of lines in the adjusted text; you can assume $0\leq L \leq T-H$ and $H< T$.
